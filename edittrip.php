	...
	include 'connection.php';
	 error_reporting(0);
	  ...
	  if($_POST['edittrip']){
		...
		$sql = "UPDATE trip SET cel = '$cel', opis = '$opis', trwanie = '$trwanie' WHERE id = '$id'";
		...
		<div class="wrapper">
			...
			<div class="content">
				<form method="POST" action="edittrip.php">
					...
					Podaj cel wycieczki: <input type="text" name="cel" required><br>
					Podaj opis wycieczki: <input type="text" name="opis" required><br>
					Podaj czas trwania wycieczki: <input type="text" name="trwanie" required><br>				
